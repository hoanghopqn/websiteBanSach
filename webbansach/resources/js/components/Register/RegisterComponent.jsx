      ...
      <div className='form-content'>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
              ...
              {!Rhide ?<>
                  ...
                  <input className={errors.RetypePassword&&'error-input'} type='password' placeholder='enter RetypePassword...' {...register('RetypePassword',{required:true, minLength: 8,validate: (value)=>{
                  ...
                  <label>RetypePassword:</label>
                  <input className={errors.RetypePassword&&'error-input'} type='text' placeholder='enter RetypePassword...' {...register('RetypePassword',{required:true, minLength: 8,validate: (value)=>{
                            const password = getValues('matkhau');
                            if(value!==password)
                            {
